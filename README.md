...
The native build is maintained on the `streamverse-native-base` branch. GitHub Actions fetches the GPLv3 upstream source, applies the StreamVerse patch, and builds a universal debug APK for Fire TV and Android TV.
